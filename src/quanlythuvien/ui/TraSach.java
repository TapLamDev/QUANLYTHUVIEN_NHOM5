...
public class TraSach extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CẢM ƠN QUÝ KHÁCH!!!");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 280, -1));

        jLabel1.setText("Mã hóa đơn:");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 250, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(117, 76, 36));
        jLabel4.setText("Bấm OK để quay trở lại trang chủ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 470, 50));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(117, 76, 36));
        jLabel5.setText("Quý khách vui lòng lưu lại mã hóa đơn để trả lại sách!");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 470, 50));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 350, 140, 30));
