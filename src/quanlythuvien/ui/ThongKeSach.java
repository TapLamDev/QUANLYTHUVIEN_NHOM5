...
public class ThongKeSach extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("THỐNG KÊ SÁCH");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 30, 150, 20));

        txtTimKiem1.setText(" Nhập sách cần tìm...");
        txtTimKiem1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        getContentPane().add(txtTimKiem1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 310, 30));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quanlythuvien/icon/search 2 2.png"))); // NOI18N
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 70, 70, 60));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, 600, 190));
